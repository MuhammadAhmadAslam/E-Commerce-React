...
export default function ShoppingCart() {
  ...
  function calculateTotal() {
    let cartedPrice =  cartedData.reduce((total, product) => total + product.price * product.quantity, 0);
    let dcCharges = 250
    cartedPrice = cartedPrice + dcCharges;
    return cartedPrice;
  }
          ...
          >
            {
              ...
              activeOrderState.map((product , index) => (
                <section>
                  ...
                  <p><strong>Total Amount : </strong>  PKR  {product.TotalAmount}</p>
                  <details>
              ...
              >
                ...
                <div className="d-flex align-items-center mb-2" style={{ flexWrap: "wrap" }}>
                  ...
                  <div className="d-flex flex-column" style={{ flexGrow: 1 }}>
                    ...
                    <p className="text-muted mb-0">PKR {data.price}</p>
                  </div>
                </div>
            ...
            <div className="row coupon-checkout-section" style={{ backgroundColor: "white", padding: "20px", borderRadius: "10px", marginTop: "25px", boxShadow: "0 4px 12px rgba(0, 0, 0, 0.05)" }}>
              ...
              <div className="col-sm-12 col-md-6 d-flex flex-column justify-content-start" style={{ padding: "10px" }}>
                ...
                <div className="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <span className="text-primary fw-bold">PKR {calculateTotal().toFixed(2)}</span>
                </div>
