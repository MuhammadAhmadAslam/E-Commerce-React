...
const Collection = () => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>{"Shop On"} - Stop n Buy</title>
	 <meta name="description" content="Browse the best products on our online store. Find trending products, latest arrivals, and more. Shop now!" />
        <meta name="keywords" content="buy products online, trending products, latest products, best online store, fashion, electronics, home goods" />
      ...
      <div>
        <div style={{ width: "100%" }} className="div-hae">
          ...
          <div
            className="col-12 col-md-8 col-lg-9 col-xxl-10 position-relative"
