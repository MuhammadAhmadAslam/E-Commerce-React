					...
					<article className="col-12 col-sm col-lg-8 mb-3">
...

						{
							isItemAdded(productData._id) && (
								<Link to="/cart" className="addcart-btn btn rounded-0 bg-black my-3 c-white mt-4 trans-3 mb-2 py-2 px-4" style={{ color: "linear-gradient(270deg, #fff09e, #c3812a, #fff09e, #c3812a)", cursor: "pointer" }}>Go To Cart</Link>
							)
						}
						</div>
						{/* Product Description and Reviews */}
