...
const ProductDetails = () => {
  ...
  return (
    ...
    >
     <Helmet>
            <title>{productData.name} - Stop n Buy</title>
            <meta
              name="description"
        ...
        <main className="product-wrapper d-flex gap-3 gap-lg-5 flex-wrap align-items-start">
          ...
          <article className="col-12 col-sm col-lg-8 mb-3">
            ...
            <button
              ...
              disabled={isItemAdded(productData._id) ? true : false}
            ...
            <div>
              {isItemAdded(productData._id) && (
                <Link
                  to="/cart"
                  className="addcart-btn btn rounded-0 bg-black my-3 c-white mt-4 trans-3 mb-2 py-2 px-4"
                  style={{
                    color:
                      "linear-gradient(270deg, #fff09e, #c3812a, #fff09e, #c3812a)",
                    cursor: "pointer",
