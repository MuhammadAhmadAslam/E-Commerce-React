      ...
      <nav className="w-100 bg-black  z-10 mb-5">
          ...
          <div className="d-flex justify-content-between align-items-center py-3">
            ...
            <div className="d-none d-md-flex align-items-center gap-2">
              ...
              <div className="relative">
                {searchVisible ? (
                  <CloseOutlined
                    className="text-xl cursor-pointer text-white absolute top-0 right-0"
                    style={{ fontSize: "20px" }}
                ...
                {searchVisible && (
                  <div
                    className="position-absolute w-100 p-4  z-20"
        ...
        >
          <div className="d-flex flex-column">
            <Link
              to="/"
              className="nav-link-hovers mx-3"
              style={{
                textDecoration: "none",
                fontSize: "29px",
                color: "#000",
        ...
        {searchVisible && (
          <div
            className="position-absolute start-0 w-100 p-4 shadow-md z-20 d-md-none"
            style={{ marginBottom: "50px", zIndex: "22" }}
          >
            <input
              type="text"
              placeholder="Search..."
